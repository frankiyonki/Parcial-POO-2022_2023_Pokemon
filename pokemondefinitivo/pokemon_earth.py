        ...
        def __init__(self, id, pokemon_name, weapon_type, health_points,
            ...
            while True:
                try:
                    ...
                    if defense < 0 or defense > 20:
                        defense_rating = input("Ingrese una valor de defensa válido entre 0 y 20: ")
                    else:
                        self.defense_rating = defense_rating
                        break
                except ValueError:
                    defense_rating = input("Ingrese un valor de defensa válido entre 0 y 20: ")
